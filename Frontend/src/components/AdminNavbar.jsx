    ...
    <nav className={`${navBg} w-full z-50`}>
      <div className="container mx-auto flex items-center justify-between py-3 px-4">
        ...
        <div className="hidden sm:flex space-x-4 items-center">
          <Link to="/admin/donations" className={redBtn}>
            View Donations
          </Link>
          <Link to="/admin/inventory" className={redBtn}>
            Blood Inventory
          </Link>
          <Link to="/admin/requests" className={redBtn}>
            Blood Requests
          </Link>
        </div>
      ...
      {mobileMenu && (
        <div className="sm:hidden bg-white shadow-md border-t border-gray-100">
          <Link to="/admin/donations" className="block px-6 py-4 text-[#ea384c] font-semibold" onClick={() => setMobileMenu(false)}>
            View Donations
          </Link>
          <Link to="/admin/inventory" className="block px-6 py-4 text-[#ea384c] font-semibold" onClick={() => setMobileMenu(false)}>
            Blood Inventory
          </Link>
          <Link to="/admin/requests" className="block px-6 py-4 text-[#ea384c] font-semibold" onClick={() => setMobileMenu(false)}>
            Blood Requests
          </Link>
        </div>
      )}
